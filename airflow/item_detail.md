...
<details>
<summary>🔍 <strong>Explain 결과</strong></summary>
...
<details>
<summary>🔍 <strong>문제 원인</strong></summary>
...
잘못된 쿼리여도 병렬 처리시 시간이 얼마나 줄어드는지 확인을 해보았습니다.

그런데 병렬로 처리하니 리소스 부족으로 성능이 낮아서 그런지 더 오래 걸렸습니다.

성능이 개선된 점은 체감하지 못했습니다.
...
- 처음에는 문제의 원인을 모른 채 DAG을 병렬로 구성 + LIMIT/OFFSET 전략
  ...
  - 병렬 실행으로 수정해도, 리소스가 부족하여 오래 걸립니다.
...
<details>
<summary>🔍 <strong>Dag Code</strong></summary>
...
### Item detail upsert query

현재 사용중인 아이템 상세 upsert query 입니다.

<details>
<summary>🔍 <strong>Upsert Query</strong></summary>
